...
import com.usermind.elidetest.spring.NoopBean;
...
public abstract class ElideBundle<T extends Configuration>
    ...
    protected ElideBundle(String[] pckgs) {
        this(findEntityClassesFromDirectory(pckgs));
    }
    ...
    @Override
    public EntityDictionary getEntityDictionary(T configuration, Environment environment) {
    ...
    public void run(T configuration, Environment environment) throws Exception {
        ...
        final JsonApiMapper jsonApiMapper = new JsonApiMapper();
