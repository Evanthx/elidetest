 ...
 */
package com.usermind.elidetest.swagger;

import com.usermind.elidetest.dropwizard.WorkerConfiguration;
...
/**
 * A {@link ConfiguredBundle} that provides hassle-free
...
public abstract class SwaggerBundle<T extends Configuration>
    ...
    public void run(T configuration, Environment environment) throws Exception {
        final WorkerConfiguration swaggerBundleConfiguration = getSwaggerBundleConfiguration(
                configuration);
        ...
        environment.jersey().register(new SwaggerURLHandler(
                configurationHelper.getUrlPattern(),
                swaggerBundleConfiguration));
    }

    protected abstract WorkerConfiguration getSwaggerBundleConfiguration(
            T configuration);
}
